(() => {
 ...
 const BOOK_ALIASES = {
      // Códigos/abreviaturas habituales
    gen: 'genesis',
    exod: 'exodo',
    lev: 'levitico',
    num: 'numeros',
    ...
    // RKANT (nombres completos en inglés)
    matthew: 'mateo',
    mark: 'marcos',
    luke: 'lucas',
    john: 'juan',
    acts: 'hechos',
    romans: 'romanos',
    '1_corinthians': '1_corintios',
    '2_corinthians': '2_corintios',
    galatians: 'galatas',
    ephesians: 'efesios',
    philippians: 'filipenses',
    colossians: 'colosenses',
    '1_thessalonians': '1_tesalonicenses',
    '2_thessalonians': '2_tesalonicenses',
    '1_timothy': '1_timoteo',
    '2_timothy': '2_timoteo',
    titus: 'tito',
    philemon: 'filemon',
    ...
    // Hebreo (IdiomaORIGEN/frecuencias)
    'בראשית': 'genesis',
    'שמות': 'exodo',
    'ויקרא': 'levitico',
    'במדבר': 'numeros',
    ...
    'מלכים_א': '1_reyes',
    'מלכים_ב': '2_reyes',
    'דברי_הימים_א': '1_cronicas',
    'דברי_הימים_ב': '2_cronicas',
    'עזרא': 'esdras',
    'נחמיה': 'nehemias',
    'אסתר': 'ester',
    'איוב': 'job',
